...
LRESULT CALLBACK    WindowProces(HWND, UINT, WPARAM, LPARAM);
...
//
//
LRESULT CALLBACK WindowProces(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    switch (message)
    {
    case WM_CREATE:
