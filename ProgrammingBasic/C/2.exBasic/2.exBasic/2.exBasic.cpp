...
void BateriaMain()
{
	...
	while (true)
	{
		nBateria = nBateria * 2;//10 * 2 = 20 //20 * 2 = 40 //40 * 2 = 80 //80*2 = 160
		nTime = nTime + 1; //1 //2 //3 //4
		printf("Bateria:%d Time:%d\n", nBateria, nTime); //20 , 1 //40, 2
		if (nBateria > 100) break; //20 > 100 -> F //40 > 100 -> F //80 > 100 -> F // 160 > 100 -> T
	}
}
